...
import 'package:myapp/presentation/widgets/body/intro/intro_section.dart';
...
class _HomeBodyState extends State<HomeBody> {
  ...
  AppBar buildAppBar(BuildContext context) {
    return AppBar(
      leading: IconButton(
        icon: const Icon(Icons.menu), // Use any icon you prefer
        onPressed: () {
      ...
      child: Stack(
        children: [
          SingleChildScrollView(
            ...
            child: Column(
              children: [
                Homepage(key: introKey),
                MediaPage(key: aboutKey),
                GivingPage(key: projectKey),
